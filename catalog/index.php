...
?>
<?$APPLICATION->IncludeComponent("bitrix:catalog", "customized", array(
	"IBLOCK_TYPE" => "catalog",
	"IBLOCK_ID" => "2",
	"TEMPLATE_THEME" => "site",
	...
	"ELEMENT_SORT_FIELD" => empty($request['SORT_FIELD']) ? "sort" : $request['SORT_FIELD'],
	"ELEMENT_SORT_ORDER" => empty($request['SORT_ORDER']) ? "asc" : $request['SORT_ORDER'],
